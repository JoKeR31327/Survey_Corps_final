...
### Running Against Cloud Run (GCP)

Set the service URLs to your Cloud Run endpoints before running tests:

INVENTORY_SERVICE_URL=https://inventory-service-186174310908.us-central1.run.app
ORDER_SERVICE_URL=https://order-service-186174310908.us-central1.run.app
USER_SERVICE_URL=https://user-service-186174310908.us-central1.run.app

Then run the same test commands as usual.
